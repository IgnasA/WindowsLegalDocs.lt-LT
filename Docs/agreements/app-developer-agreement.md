...
1. **APIBRĖŽTYS.** Šioje Sutartyje taikomos šios apibrėžtys:
   ...
   b. Susijusi įmonė – bet kuris juridinis asmuo, kuriam priklauso šalis, kuris priklauso šaliai arba kuris kartu su šalimi priklauso bendros nuosavybės teise. „Nuosavybė“ reiškia daugiau nei 50 % nuosavybės teisių arba teisę valdyti įmonę.
   ...
   p. Programėlėje įsigyjamas produktas – papildoma skaitmeninė prekė, įskaitant atsisiunčiamą papildomą turinį, skirtą Programėlei, kuri siūloma Klientui įsigyti „Store“ platformoje fiksuotu ar pasikartojančiu pagrindu; po to, kai klientas įsigyja Produktą Programėlėje, kūrėjas pateikia jį į Programėlę.
   ...
   ff. „Microsoft Store“ švietimui – programa, kurią Švietimo institucijoms teikia „Microsoft“, kad jos galėtų įsigyti ir pradėti platinti Programėles ir Programėlėse įsigyjamus produktus, kuriuos galėtų naudoti kiekvienos tokios Švietimo institucijos įgaliotieji darbuotojai, agentai ir nariai.
...
3. **PROGRAMĖLIŲ PATEIKIMAS, ĮVERTINIMAS, SERTIFIKAVIMAS IR PLATINIMAS.**
   ...
   d. **Pradinis sertifikavimas.** „Microsoft“ patikrins kiekvieną jūsų pateiktą Programėlę (įskaitant visus naujinimus), ar jos atitinka šios Sutarties sąlygas (kurios apima taikomus Sertifikavimo reikalavimus) ir kitas jums pasiekiamas strategijas (jei tokių yra). „Microsoft“ nepateiks „Store“ platformoje jokios Programėlės, kol ji nebus Sertifikuota.
...
6. **PROGRAMĖLIŲ KAINODARA, MOKĖJIMAI, OPERACIJOS IR MOKESČIAI.**
   ...
   c. **Prekybos plėtimo reguliavimas.** Visų Programėlių ir Programėlėse įsigyjamų produktų operacijų, kurioms taikomas Prekybos plėtimo reguliavimas, atveju „Microsoft“, be taikomo „Store“ mokesčio, pasiliks taikomą Prekybos plėtimo reguliavimo procentą.
...
2. **Įmonės licencijos naudojimas ir apribojimai.**
...
1. **Licencijų suteikimas.** Neatsižvelgiant į tai, kas nurodyta Sutarties 4 skyriaus a dalies antrajame sakinyje ir 4 skyriaus b dalies pirmajame sakinyje, šalyje (-yse), kurios yra nurodytos šiame Įrodymų dokumente C, kurioje (-ose) nusprendžiate siūlyti savo Programėlę (-es) arba Programėlėje įsigyjamą (-us) produktą (-us), jūs suteikiate „Microsoft“ licenciją (kurią leidžiate „Microsoft“ savo nuožiūra sublicencijuoti jos pardavimo partneriams, o tiems pardavimo partneriams sublicencijuoti kitiems pardavimo partneriams) teikti Programėlę arba Programėlėje įsigyjamą produktą Klientams platformoje „Store“. Pateikdami Programėlę jūs neperduodate nuosavybės teisių „Microsoft“, bet suteikiate „Microsoft“ licenciją (kurią leidžiate „Microsoft“ savo nuožiūra sublicencijuoti jos pardavimo partneriams, o tiems pardavimo partneriams – sublicencijuoti kitiems pardavimo partneriams) šalyje (-yse), nurodytose šiame Įrodymų dokumente C, kurioje (-ose) nusprendžiate siūlytei savo Programėlę, (a) teikti komerciniais pagrindais, diegti, naudoti, atkurti, viešai demonstruoti ir rodyti per bet kurią skaitmeninę perdavimo technologiją, formatuoti, padaryti Klientams prieinamą (įskaitant platinimą per kelis platinimo lygius), įterpti trečiųjų šalių reklamos valdiklius (kuriuos pasirinkote Kūrėjų centre) ir pasirašyti Programėlę (-es) (taip pat pašalinti esamus parašus) visais „Microsoft“ teisių ir įsipareigojimų vykdymo pagal šią Sutartį tikslais, įskaitant jūsų Programėlės Sertifikavimą ir įsibrovimo ar kitų patikrų atlikimą, siekiant nustatyti saugos pažeidžiamumo riziką, ir (b) tiesiogiai arba netiesiogiai per įgaliotuosius partnerius (įskaitant pagal sublicencijavimo sutartį) teikti komerciniais pagrindais, atkurti, teikti į rinką, reklamuoti, siūlyti ir padaryti Klientams prieinamą (-as) jūsų Programėlę (-es) bei teikti į rinką, reklamuoti, siūlyti ir padaryti Klientams prieinamą (-us) Programėlėje įsigyjamą (-us) produktą (-us). Jūs toliau licencijuosite savo Programėlę (-es) ir licencijuosite bei teiksite Klientams savo Programėlėje įsigyjamą (-us) produktą (-us), kaip nurodyta Sutarties 4 skyriaus g dalyje. „Microsoft“ taip pat gali periodiškai įvertinti jūsų Programėlę, kai ji tampa pasiekiama platformoje „Store“, kad patikrintų, ar ji toliau atitinka šios Sutarties reikalavimus, yra suderinama su „Microsoft“ programėlių kūrimo ir platinimo platformomis, ir kad galėtų patobulinti „Microsoft“ programėlių kūrimo ir platinimo platformas.

2. **Rinkodaros teisės.** Jūs suteikiate „Microsoft“, jos agentams, rangovams, licencijų turėtojams (įskaitant „Microsoft“ įgaliotuosius pardavimo partnerius), rinkodaros partneriams ir Susijusioms įmonėms teisę naudoti, atkurti, rodyti, viešai demonstruoti ir publikuoti jūsų įmonės pavadinimą, Programėlę arba Programėlės dalį, Programėlėje įsigyjamą produktą ir kiekvienos Programėlės išteklius, taip pat keisti jūsų Programėlės aprašą, tik siekiant ištaisyti akivaizdžias rašybos, gramatikos ar tipografines klaidas, kiek tai susiję su (i) Programėlės ar Programėlėje įsigyjamo produkto platinimu platformoje „Store“, (ii) Programėlės ar Programėlėje įsigyjamo produkto reklamavimu bet kurioje medijoje, įskaitant „Microsoft“ partnerių programą (žr. http://www.microsoftaffiliates.com)), ir (iii) bet kokiais Programėlės, Programėlėje įsigyjamo produkto, „Windows“, „Windows Phone“, „Xbox“ aparatūros ir priedų, „Xbox Live“ paslaugų, Xbox.com ir kitų su „Windows“, „Windows Phone“ ir (arba) „Xbox“ susijusių svetainių ir visų iš jų sukurtų platformų ir (arba) bet kurių kitų „Microsoft“ svetainių, produktų ir paslaugų, susijusių su „Store“ ir (arba) Programėlėmis, rinkodaros, pateikimo, demonstravimo veiksmais, prekybos parodomis, rinkos įvykiais ir spaudos pranešimais. Tačiau nė viena šios sutarties nuostata nesudarys kliūčių „Microsoft“ naudoti jūsų Programėlės, Programėlės išteklių ir (arba) Programėlėje įsigyjamo produkto be licencijos, jei tai leidžia įstatymai (pvz., sąžiningas naudojimas pagal taikomą autoriaus teisių įstatymą arba „rekomenduojamas“ naudojimas pagal prekių ženklų įstatymą).

3. **Programų kainos; Programų mokesčiai.** Neatsižvelgiant į tai, kas nurodyta Sutarties 6 skyriuje, kai pateikiate Programėlę ir nusprendžiate padaryti Programėlę ar Programėlėje įsigyjamą produktą pasiekiamą, kaip nurodyta šiame Įrodymų dokumente C, galite siūlyti kainą (jei tokia yra), kuri bus taikoma Klientams (atsižvelgiant į „Microsoft“ Dokumentuose nurodytus kainos taškus) toje šalyje, ir „Microsoft“ gali taikyti tą kainą (ar kitą „Microsoft“ arba pardavimo partnerio savo nuožiūra pasirinktą kainą), kad jūsų Programėlė ar Programėlėje įsigyjamas produktas būtų pasiekiamas platformoje „Store“ toje šalyje. Kiekvienos Programėlės arba Programėlėje įsigyjamo produkto, kurį norite pateikti, kaip nurodyta šiame Įrodymų dokumente C, atveju, „Microsoft“ (arba pardavimo partneris ar atsiskaitymo paslaugų teikėjas) rinks ir perves pardavimo, naudojimo, prekių ir paslaugų, pridėtinės vertės ar panašius mokesčius, jei tokių yra, taikomus, kai Klientas „Store“ įsigyja jūsų Programėlę arba Programėlėje įsigyjamą produktą tokioje (-ose) šalyje (-yse), kaip nurodyta šiame Įrodymų dokumente C. Jei šiame dokumente nenurodyta kitaip, „Microsoft“ negali pervesti jokių pardavimo, naudojimo, prekių ir paslaugų, pridėtinės vertės ar kitų panašių mokesčių, susijusių su Klientų jūsų Programėlės (-ių) arba Programėlėje įsigyjamo (-ų) produkto (-ų) įsigijimu.

4. **Mokėjimo sąlygos ir mokesčiai.** Programėlės pajamos, išmokamos jums, kai šiame Įrodymų dokumente C nurodytoje (-ose) šalyje (-yse) parduodama jūsų Programėlė arba Programėlėje įsigyjamas produktas, bus apskaičiuojamos ir išmokamos, kaip nurodyta 6 skyriaus d dalyje, tačiau Programėlės pajamos bus teikiamos kaip autorinis mokestis mainais už šio Įrodymų dokumento C 1 paragrafe suteiktą licenciją.



## <a name="exhibit-d-terms-and-conditions-for-preloaded-apps"></a>ĮRODYMŲ DOKUMENTAS D: IŠ ANKSTO ĮKELTŲ PROGRAMĖLIŲ SĄLYGOS

Šis išankstinio įkėlimo įrodymų dokumentas (Įrodymų dokumentas D) yra Programėlių kūrėjo sutarties sąlygų priedas. Įrodymų dokumentas D taikomas tik tada, jei „Microsoft“ ir jūs Išankstinio įkėlimo priede atskirai sutariate Iš anksto kelti jūsų Programėlę į „Microsoft“ produktus. Išskyrus sąlygas, kurios yra aiškiai modifikuotos šiame Įrodymų dokumente D, visos Programėlių kūrėjo sutarties, kuri yra įtraukta į šį dokumentą kaip nuoroda, sąlygos taikomos, kai jūsų Programėlė yra Iš anksto įkeliama.

1. **Apibrėžtys.** Didžiosiomis raidėmis parašyti terminai, kurie šiame dokumente nėra apibrėžti, turi tokią pačią reikšmę, kaip Programėlių kūrėjo sutartyje pateikti terminai.

   a. Klaida (-os) – tai bet kuri klaida, problema, defektas, gedimas arba trūkumas, dėl kurios jūsų Programėlė veikia netinkamai arba neveikia ir (arba) neveikia kartu su „Microsoft“ produktais.

   b. „Microsoft“ produktai – tai bet kuris įrenginys arba aparatūra, pagaminta arba siūloma „Microsoft“ arba „Microsoft“ vardu. Jūs sutinkate, kad „Microsoft“ Atsakomybės atsisakymas dėl garantijos apima visus Išankstinio įkėlimo priede nurodytus „Microsoft“ produktus.

   c. Išankstinis įkėlimas – tai tiesioginis jūsų Programėlės (-ių) platinimas „Microsoft“ produktuose, kad Klientai galėtų būti pasiekti Programėlę (-es) tiesiai iš „Microsoft“ produkto, neatsisiųsdami Programėlės (-ių) iš „Store“.

   d. Išankstinio įkėlimo priedas – tai jūsų ir „Microsoft“ vykdomas rašytinis priedas, kuriame nurodoma, kurias jūsų Programėles galima Įkelti iš anksto į nustatytus „Microsoft“ produktus.

   e. Terminas – tai dvejų (2) metų laikotarpis, prasidedantis nuo Išankstinio įkėlimo priedo įsigaliojimo datos. Po pirmų dvejų (2) metų, Išankstinio įkėlimo priedas liks galioti, kol kuri nors šalis jį nutrauks, pranešusi apie tai kitai šaliai raštu prieš šešis (6) mėnesius.

   f. Naujinimas (-ai) – tai jūsų Programėles modifikacijos, apimančios Klaidų taisymus ir (arba) užtikrinančios funkcinius, veikimo, vartotojų patirties arba kitus patobulinimus.

2. **Licencija, suteikianti teisę įkelti programėles iš anksto.** Kartu su teisėmis, kurios suteikiamos pagal Programėlių kūrėjo sutartį, jūs suteikiate „Microsoft“ pasaulinę, neišimtinę, Termino metu neatšaukiamą, nemokamą, visiškai apmokėtą teisę ir licenciją Iš anksto įkelti jūsų Programėlę (-es) į „Microsoft“ produktus, kaip nurodyta ir sutarta Išankstinio įkėlimo priede.

3. **Papildomi Išankstinio įkėlimo įsipareigojimai.**

   3.1 **Tęstinis publikavimas.** Neatsižvelgiant į tai, kas buvo nurodyta priešingai Programėlių kūrėjo sutartyje, tuo atveju, jei pagal Išankstinio įkėlimo priedą jūsų Programėlė (-ės) yra įkeliama (-os) iš anksto, jūs sutinkate (i) nenutraukti Programėlių kūrėjo sutarties jos galiojimo laikotarpiu ir (ii) Sutarties galiojimo laikotarpiu palikti savo Programėlę (-es) platformoje „Store“.

   3.2 **Pristatymas.** Programėlę (-es) turite pateikti „Microsoft“ savo sąskaita ne vėliau nei Išankstinio įkėlimo priede sutartą datą, ir ji turi būti pateikiama tinkamoje laikmenoje bei formatu (kaip nurodė „Microsoft“), tinkamu Išankstiniam įkėlimui į „Microsoft“ produktus. Prieš pristatydami tokią (-as) Programėlę (-es) „Microsoft“ turite patikrinti, ar Programėlėje (-ėse) nėra klaidų, ir įsitikinti, ar ji (jos) atitinka „Microsoft“ apibrėžtus reikalavimus ir veikia su Išankstinio įkėlimo priede nurodytais taikomais „Microsoft“ produktais.

   3.3 **Tikrinimas, priėmimas arba atmetimas.** „Microsoft“ gali papildomai patikrinti jūsų Programėlę (-es), ne tik atlikdama Sertifikavimą, kad užtikrintų Klientams gerą Programėlės naudojimo patirtį „Microsoft“ produktuose. Jei „Microsoft“ aptiks Klaidų, „Microsoft“ praneš jums apie jas ir gali atmesti jūsų Programėlę (-es) kaip netinkamą (-as) Išankstiniam įkėlimui. Jei „Microsoft“ atmes jūsų Programėlę, jūs sutinkate ištaisyti tokias Klaidas per trisdešimt (30) dienų nuo pranešimo apie atmetimą.

   3.4 **Klaidos ir naujinimai.** Jūs sutinkate ištaisyti visas esmines Klaidas, kurios buvo aptiktos (kuriai nors šalies) jūsų Programėlėje (-ėse) po Išankstinio įkėlimo, ir greitai paskelbti Naujinimus platformoje „Store“. Jūs užtikrinsite, kad bet kurie Naujinimai yra suderinami su Išankstiniam įkėlimui pasirinktais „Microsoft“ produktais.

   3.5 **FOSS pretenzijos.** Jeigu kuri nors šalis gauna (ir garbingai pripažįsta) kurios nors trečiosios šalies pretenziją, kad jūsų Programėlė (-ės) pažeidžia kurias nors FOSS licencijos sąlygas, jūs sutinkate nedelsdami pašalinti pretenzijos pagrindą (pvz., pateikti trūkstamus pranešimus arba priskyrimus, pristatyti pagrindinį išeitinį kodą ir pan.) ir (arba) Atnaujinti Programėlę, taip pašalinant FOSS, kuri yra pretenzijos pagrindas.

4. **Nutraukimo pasekmės.** Išankstinio įkėlimo priedo nutraukimas arba jo pasibaigęs galiojimas neturės įtakos jokioms Kliento teisėms, leidžiančioms naudoti jūsų Programėlę (-es). Per šešis (6) mėnesius (arba anksčiau, jei įmanoma) nuo Išankstinio įkėlimo priedo nutraukimo arba galiojimo pabaigos „Microsoft“ nutrauks jūsų Programėlės (-ių) Išankstinį įkėlimą ir nebenaudos su ja (jomis) susijusių Programėlės išteklių, atsižvelgiant į tai, kokiame gamybos proceso etape yra paveikti „Microsoft“ produktai. Išankstinio įkėlimo priedo nutraukimas arba jo pasibaigęs galiojimas neturės įtakos „Microsoft“ teisei parduoti ar platinti „Microsoft“ produktus, kuriuose pagal Išankstinio įkėlimo priedą Iš anksto įkeliama (-os) jūsų Programėlė (-ės).


## <a name="exhibit-e-advertising-services-addendum"></a>ĮRODYMŲ DOKUMENTAS E: REKLAMOS PASLAUGŲ PRIEDAS

Paskutinį kartą atnaujinta: 2017 m. spalio 26 d.

Šis reklamos paslaugų priedas (šis „**Priedas**“) yra Programėlių kūrėjo sutarties; „Microsoft Store“ („Sutartis“) sąlygų priedas. Šis Priedas taikomas, jei pasirenkate naudoti „Microsoft“ reklamos paslaugas, kaip aprašyta šiame Priede. Išskyrus sąlygas, kurios yra aiškiai modifikuotos šiame Priede, visos Sutarties, kuri yra įtraukta į šį dokumentą kaip nuoroda, sąlygos taikomos jūsų „Microsoft“ reklamos paslaugų naudojimui. Didžiosiomis raidėmis parašyti terminai, kurie šiame dokumente nėra apibrėžti, turi tokią pačią reikšmę, kaip Sutartyje pateikti terminai.

1. **ĮVADAS.**

  Šio Priedo sąlygos yra jūsų ir „Microsoft Online, Inc.“, įsikūrusios 6100 Neil Road, Reno, NV 89511 USA, („**Microsoft**“) sutartis. Jei nesate su „Microsoft“ sudarę atskiros sutarties dėl „Microsoft Advertising“ paslaugos ar programos, šis Priedas taikomas jūsų dalyvavimui vienoje arba keliose „Microsoft“ reklamos paslaugose ir programose arba jų naudojimui.

2. **„MICROSOFT ADVERTISING“ PASLAUGOS STRATEGIJOS.**

   a. **Reklamuotojų teisė sutikti arba atsisakyti.** „Microsoft“ gali pateikti reklamuotojams Programėlių ir kūrėjų vardų sąrašą, kurį naudodami reklamuotojai galės nuspręsti, kurių kūrėjų Programėlėse jie nori arba nenori skelbti savo reklamas. „Microsoft“ neturės jums atskleisti, ar kuris nors reklamuotojas pasinaudojo šia teise jūsų ar jūsų Programėlių atžvilgiu.

   b. **Diegimo įsipareigojimai.** Jūs:

   > i. turite įdiegti: (1) „Microsoft Store“ paslaugų SDK savo programėlėse (jei taikoma) ne vėliau kaip trys dienos prieš reklamos teikimo Programėlėje įgalinimą **pagal jums pateiktus „Microsoft“ nustatytus techninius reikalavimus** ir (2) naujinimus, kuriuos „Microsoft“ atliko „Microsoft Store“ paslaugų SDK, per 60 dienų nuo tada, kai „Microsoft“ pateikia jums „Microsoft Store“ paslaugų SDK naujinimą;

   > ii. turite savo Programėlėse patikrinti: (1) skelbimų formatų ir naršyklių diegimą ir (2) „Microsoft“ nurodytus „Microsoft Store“ paslaugų SDK atliktus „Microsoft“ pakeitimus;

   > iii. turite laiku dėti pagrįstas pastangas, kad bendradarbiaudami išspręstumėte problemas, kurios buvo nurodytos tikrinant jūsų Programėles, ir

   > iv. turite į savo Programėles įtraukti bet kokias ir visas „Microsoft“ pateiktas rekomendacijas, specifikacijas, išdėstymo gaires, dokumentus ir kitus su reklaminiais skelbimais susijusius patarimus (pvz., vieta, dydis, funkcijos, formatas ir kt.).

   c. **COPPA pranešimų reikalavimai.** Jei jūsų programėlė yra skirta jaunesniems nei 13 metų vaikams (kaip apibrėžta Vaikų privatumo internete saugos akte), jūs turite (i) apie tai pranešti „Microsoft“ Kūrėjų centro Apmokestinimo dalyje ir (ii) užtikrinti, kad visas programėlėje rodomas reklamos turinys tinkamas jaunesniems nei 13 metų vaikams.

   d. **Bendruomenės skelbimų programa.** Jei nusprendžiate dalyvauti „Microsoft“ bendruomenės skelbimų programoje, jūs patvirtinate ir sutinkate, kad:

   > i. Negausite jokių pajamų už jūsų Programėlėse rodomus Bendruomenės skelbimus.

   > ii. Bet kokie Bendruomenės skelbimų kreditai, kuriuos gaunate dalyvaudami Bendruomenės skelbimų programoje, negali būti perduodami ir neturi piniginės vertės.

   > iii. Visus kreditus, gautus dalyvaujant Bendruomenės skelbimų programoje, galima naudoti tik kuriant reklamos kampanijas Bendruomenės skelbimų programos ribose.

   > iv. Visi sukaupti kreditai, gauti dalyvaujant Bendruomenės skelbimų programoje, bus panaikinti, jei jūs arba „Microsoft“ nutrauks jūsų dalyvavimą programoje, arba jei „Microsoft“ nutrauks, atšauks arba laikinai sustabdys programą.

3. **ATASKAITOS.**

   Teikdama reklamos paslaugas „Microsoft“ gali suteikti jums prieigą prie internetinių ataskaitų teikimo sistemų (bendrai – „**Ataskaitų sričių sistemos**“), kad galėtumėte peržiūrėti ir naudoti daugybę internetinių ataskaitų, susijusių su jūsų „Microsoft“ reklamos paslaugų naudojimu. Negalite viešai publikuoti ar kitaip platinti arba trečiosioms šalims atskleisti nė vienos iš šių ataskaitų ir šias ataskaitas galite naudoti tik jūsų vidiniais verslo tikslais.

4. **MOKĖJIMO STRATEGIJOS.**

   Kartą per mėnesį „Microsoft“ mokės jums už jūsų Programėlėse rodomą reklamą, ir šis mokestis bus pagrįstas tuo metu galiojančiomis mokėjimo strategijomis, jei jūsų pajamų balansas viršys tuo metu tokiose strategijose nurodytas minimalias mokėjimo sumas. Jūsų faktiškai gaunamos mokėjimo sumos iš dalies priklausys nuo jūsų finansų institucijos taikomų tarifų ir mokesčių bei visų taikomų mokesčių išskaitymo reikalavimų. Be to, į visas jūsų gautas mokėjimo sumas bus įtraukti pardavimo, naudojimo ar pridėtinės vertės mokesčiai, kurie gali būti taikomi jums ir „Microsoft“. Palaikomos šalys, mokėjimo grafikai, mokėjimo apdorojimo informacija ir minimalios mokėjimo sumos yra aprašytos „Microsoft“ mokėjimo strategijose. „Microsoft“ gali bet kuriuo metu atnaujinti savo mokėjimo strategijas.

  Jei mokėjimas yra pagrįstas: (i) veiksmais, kuriuos sugeneravo jūsų Programėlėse rodoma reklama, (ii) jūsų Programėlėse rodomos reklamos paspaudimų skaičiumi arba (iii) jūsų Programėlėse parodytų reklamų skaičiumi, „Microsoft“ sugeneruotos ataskaitos bus vienintelis sąskaitų faktūrų išrašymo ir apmokėjimo matas. Paspaudimai, parodymai ar reklamų sugeneruoti veiksmai, (i) kuriuos „Microsoft“ užregistruoja kaip gautus iš jums priklausančių ar jūsų kontroliuojamų IP adresų arba (ii) kurie yra susiję su Sutarties, šio Priedo arba kurio nors Dokumento ar kitos jums taikomos strategijos pažeidimu, nėra galiojantys parodymai, paspaudimai ar veiksmai. „MICROSOFT“ NETEIKIA JOKIŲ PAŽADŲ AR GARANTIJŲ APIE TAI, (A) KIEK REKLAMINIŲ SKELBIMŲ „MICROSOFT“ GALI RODYTI JŪSŲ PROGRAMĖLĖSE ARBA (B) KIEK SU „MICROSOFT“ REKLAMOS PASLAUGŲ NAUDOJIMU SUSIJUSIŲ MOKĖJIMŲ GALĖTUMĖTE GAUTI.

5. **„MICROSOFT“ DUOMENŲ RINKIMAS.**

   „Microsoft“ rinks duomenis apie tai, kaip jūs naudojate jos reklamos paslaugas ir su jūsų Programėlėmis susijusią veiklą. „Microsoft“ gali naudoti šiuos duomenis generuodama bendrąsias ataskaitas, kurias gali peržiūrėti „Microsoft“ klientai ir partneriai. „Microsoft“ taip pat gali naudoti šiuos duomenis (a) tobulindama ir optimizuodama savo produktus ir paslaugas bei (b) teikdama kampanijų ataskaitas reklamuotojams, kurių reklamos buvo rodomos jūsų Programėlėse. Be to, „Microsoft“ turi teisę be jokio papildomo jūsų sutikimo ar patvirtinimo bendrinti su trečiosiomis šalimis (pvz., reklamos tinklais arba biržomis) su jūsų Programėlėmis susijusią informaciją, įskaitant, be apribojimų, Programėlės pavadinimą, jūsų, kaip Programėlės leidėjo, vardą, jūsų Programėlių ekrano kopijas, taip pat parodymų duomenis ir taikymo galimybes. Jūs sutinkate, kad šiame Skyriuje aprašyti duomenys būtų nemokamai atskleidžiami ir perduodami „Microsoft“ visame pasaulyje.

6. **PRIVATUMAS.**

   a. **Duomenų rinkimas.** Jūs prisiimate visą atsakomybę už duomenų, susijusių su jūsų Programėlių vartotojais, rinkimą, naudojimą ir atskleidimą, ir turite laikytis visų taikomų įstatymų bei taisyklių, kai renkate, naudojate ir atskleidžiate šiuos duomenis.

   b. **Vartotojo sutikimas.** Nė viena šio Priedo nuostata nenumato jokios interneto vartotojo asmeninės informacijos rinkimo arba perdavimo tarp jūsų ir „Microsoft“ be aiškaus galutinio vartotojo sutikimo. Jūs dėsite komerciškai pagrįstas pastangas užtikrinti, kad galutinis vartotojas duotų sutikimą saugoti ir pasiekti slapukus, konkretaus įrenginio informaciją, vietos informaciją arba kitą informaciją galutinio vartotojo įrenginyje, ryšium su jūsų „Microsoft“ reklamos paslaugų naudojimu, kai toks sutikimas būtinas pagal įstatymus arba kitas taikomas savireguliacijos programos gaires.

   c. **Pranešimas galutiniams vartotojams.** Jei perduosite „Microsoft“ tikslius vietos duomenis arba kitus su vartotojais susijusius duomenis (pvz., vartotojo identifikatorių, profilio duomenis, vartotojo elgsenos sekimo duomenis ir kt.) per bet kurią „Microsoft“ jums pateiktą SDK (pvz., „Microsoft Store“ paslaugų SDK) arba kitais būdais, tada:

   > i. Pranešimas. Jūsų programoje potencialiems galutiniams programos vartotojams turi būti pateiktas aiškus ir pastebimas pranešimas (matomas prieš atsisiunčiant arba naudojant programą), kuris būtų paremtas tuo metu galiojančiais įstatymais, taisyklėmis ir rinkos standartais, ir kuriame būtų nurodyta bent tokia informacija: (1) pranešimas galutiniams vartotojams, kad programa rinks ir naudos vartotojo duomenis ir teiks šiuos duomenis „Microsoft“, kuriuos ji naudos įvairiose programėlėse pagal pomėgius pritaikomoms reklamoms teikti, (2) duomenų tipų aprašas, įskaitant asmenis identifikuojančią informaciją, tikslius vietos duomenis arba asmeninio katalogo duomenis (pvz., kalendoriaus informaciją arba tekstinių žinučių žurnalus), kuriuos programa renka reklamos tikslais, (3) paaiškinimas, kaip ir kokiu tikslu surinkti duomenys bus naudojami arba perduodami „Microsoft“, ir (4) saitas, kuris suteikia vartotojams galimybę atsisakyti „Microsoft“ įvairiose programėlėse pagal pomėgius pritaikomų reklamų šiuo adresu [https://choice.live.com/AdvertisementChoice/](http://go.microsoft.com/fwlink/p/?LinkID=691621), ir

   > ii. Sutikimas. Jūsų Programėlės atsisiuntimo, diegimo arba paleidimo metu turite gauti aiškų vartotojo sutikimą (pvz., vartotojas turi spustelėti „Sutinku“ arba mygtuką „Įdiegti“) dėl tokių duomenų rinkimo ir naudojimo.

7. **PALAIKYMAS IR GRĮŽTAMASIS RYŠYS.**

  „Microsoft“ neįsipareigoja jums teikti jokio su reklamos paslaugomis susijusio techninio ar kitokio palaikymo. Jei pateiksite „Microsoft“ grįžtamąjį ryšį apie jos reklamos paslaugas, suteiksite „Microsoft“ teisę nemokamai naudoti, bendrinti ir parduoti jūsų atsiliepimus bet kokiu būdu ir bet kokiais tikslais. Jūs taip pat nemokamai suteikiate trečiosioms šalims bet kokias patentų teises, leidžiančias jų produktams, technologijoms ir paslaugoms naudotis arba susisieti su bet kuriomis konkrečiomis „Microsoft“ programinės įrangos arba paslaugos dalimis, apimančiomis jūsų atsiliepimus. Jūs neteiksite grįžtamojo ryšio, susijusio su licencija, kuri reikalauja, kad „Microsoft“ licencijuotų savo programinę įrangą arba dokumentus trečiosioms šalims, nes „Microsoft“ įtraukia jūsų atsiliepimus į savo programinę įrangą arba dokumentus. Šios teisės, kurias suteikiate „Microsoft“ ir trečiosioms šalims šiame Skyriuje, liks galioti po Sutarties, šio Priedo ar teisių naudoti „Microsoft“ reklamos paslaugas nutraukimo. Be to, gavę atsiliepimų, komentarų arba nusiskundimų iš savo Programėlių vartotojų apie bet kokias „Microsoft“ pateiktas reklamas, turite nedelsdami persiųsti šią informaciją adresu support@microsoft.com.

8. **VIEŠUMAS / INFORMACIJOS UŽKLAUSOS.**

   Jūs negalite išleisti į viešumą jokios viešos informacijos, reklamų, naujienų, viešų pranešimų, jų paneigimo ar patvirtinimo bet kokia forma dėl bet kurio šio Priedo aspekto ar jūsų ir „Microsoft“ ryšio be išankstinio rašytinio „Microsoft“ sutikimo, išskyrus „Microsoft“ ženklų naudojimo tikslais pagal Sutarties 4 skyriaus h dalį.

9. **TEISIŲ IŠSAUGOJIMAS.**

   „Microsoft“ pasilieka visas intelektinės nuosavybės teises, susijusias su jos reklamos paslaugomis, technologijomis ir visais jų patobulinimais ar pakeitimais. Remiantis „Microsoft“ ir jūsų sutarimu, jums lieka visos intelektinės nuosavybės teisės į jūsų Programėlių turinį, išskyrus „Microsoft“ ar jos klientų pateikiamą turinį. „Microsoft“ klientams liks visos teisės į jūsų Programėlėse rodomas reklamas.

10. **GARANTIJOS ATSISAKYMAS. JEI GYVENATE AUSTRALIJOJE,** nėra garantijų, numanomų pagal Australijos vartotojų teisių įstatymą, kurios gali būti taikomos prekėms ir paslaugoms, teikiamos jums kaip „Microsoft“ reklamos paslaugų dalis („**Australijos garantijos**“). Jei jums taikomos Australijos garantijos, tuomet šios Australijos garantijos neįtraukiamos į Sutarties 10 skyriuje nurodytas atsakomybės atsisakymo nuostatas ir išimtis. „Microsoft Advertising“ paslaugų, kurios apima paslaugas (o ne prekes), atveju, jei „Microsoft“ pažeidžia kurią nors iš Australijos garantijų, jūs galite tik pakartotinai gauti paslaugą arba bus apmokėta pakartotinio paslaugų teikimo kaina. „Microsoft Advertising“ paslaugų, kurios apima prekes (įskaitant kompiuterio programinę įrangą), atveju, prekėms taikomos Australijos garantijos, kurių negalima neįtraukti pagal Australijos vartotojų teisių įstatymą, ir jūs turite teisę į pakeitimą arba pinigų už esmines triktis grąžinimą ir kompensaciją už bet kokius kitus pagrįstai iš anksto numatomus nuostolius arba žalą. Jūs taip pat turite teisę į prekių taisymą arba pakeitimą, jei prekės nėra priimtinos kokybės, bet triktis nėra esminė. Programinės įrangos atveju, prekių taisymas gali būti neįmanomas, todėl šiuo atveju jos bus keičiamos. Dėl visų su Australijos garantijomis susijusių problemų kreipkitės adresu support@microsoft.com.

11. **NUOSTOLIŲ ATLYGINIMAS.**

   a. Be savo įsipareigojimų pagal Sutarties 10 skyriaus c dalį jūs turite ginti, garantuoti nuostolių atlyginimą ir atleisti „Microsoft“, jos susijusias įmones, agentus ir darbuotojus nuo bet kokių nuostolių, atsakomybės ir išlaidų (įskaitant pagrįstus mokesčius advokatams), patirtų dėl kurių nors trečiųjų šalių pretenzijų, iškeltų bylų ar pateiktų ieškinių, atsiradusių dėl ar susijusių su (i) jūsų „Microsoft“ reklamos paslaugų naudojimu, (ii) bet kokia trečiųjų šalių prieiga prie „Microsoft“ reklamos paslaugų ir jų naudojimu per jūsų paskyrą arba naudojant jūsų kredencialus; (iii) bet kurios šio Priedo sąlygos pažeidimu, įskaitant bet kurias nurodytas „Microsoft“ strategijas, ir (iv) jūsų vartotojo duomenų rinkimu, naudojimu ir atskleidimu.

   b. **Reikalavimai atlyginti žalą.** Sutarties 10 skyriaus c dalyje nurodyti įsipareigojimai, procesai ir procedūros taikomi bet kokių pretenzijų, teisminių bylų ar ieškinių, aprašytų šio Priedo 11 skyriaus b dalyje, vykdymui ir sprendimui.

12. **KITOS NUOSTATOS.**

   a. **Draudžiamų veiksmų koregavimai.** Jei jūs ar kuri nors jūsų Programėlė pažeidžia kurią nors šio Priedo, Sutarties ar kurios nors „Microsoft“ strategijos dalį, tuomet, neapribojant jokių kitų teisių ir priemonių, kurias „Microsoft“ turi pagal šį Priedą, Sutartį arba įstatymus, „Microsoft“ gali atlikti arba reikalauti bet kurių arba visų toliau nurodytų dalykų, kuriuos, atsižvelgusi į aplinkybes, „Microsoft“ laiko reikalingais, norint spręsti reklamuotojų pasitenkinimo problemas: nemokamai gauti papildomų parodymų jūsų Programėlėse, išjungti skelbimų rinkinius, pašalinti kai kuriuos arba visus jūsų Bendruomenės skelbimų programos kreditus, sulaikyti arba išskaityti jums neatliktus mokėjimus laikotarpiui, per kurį, atlikusi pagrįstą tyrimą, „Microsoft“ nustato draudžiamą veiksmą arba taikomą pažeidimą.

   b. **Nutraukimas.** „Microsoft“ turi teisę be priežasties ar paaiškinimo, apie tai įspėjusi nedelsdama visiškai ar iš dalies nutraukti arba laikinai sustabdyti jūsų naudojimąsi „Microsoft“ reklamos paslaugomis, atsižvelgdama į visas arba kai kurias jūsų programėles bet kuriuo laikotarpiu. Išskyrus jums priklausančius mokėjimus, susijusius jums „Microsoft“ teikiamomis reklamos paslaugomis, „Microsoft“ neprisiima atsakomybės prieš jus dėl bet kokio šio Priedo ar Sutarties nutraukimo ar laikino sustabdymo.

   c. **Bylų nagrinėjimo vieta; įstatymai.** Šio Priedo ir visų dėl jo kylančių ir su juo susijusių pretenzijų, nepaisant įstatymų kolizijos principo, interpretavimą reglamentuoja Nevados valstijos (JAV) teisės aktai. Jūs ir „Microsoft“ negrįžtamai sutinkate su išskirtine Vašingtono valstijos (JAV) King apygardos valstybinių ir federalinių teismų jurisdikcija bei sutinkate, kad visi dėl šio Priedo ar bet kurios „Microsoft“ reklamos paslaugos kylantys ar su jais susiję ginčai būtų nagrinėjami šiuose teismuose (t. y., ne arbitražo ir ne smulkių ieškinių teisme).


## <a name="exhibit-f-promote-your-app-program-addendum"></a>ĮRODYMŲ DOKUMENTAS F: JŪSŲ PROGRAMĖLĖS PROGRAMOS PRIEDO REKLAMAVIMAS

Paskutinį kartą atnaujinta: 2017 m. spalio 26 d.

Šis programėlės reklamavimo programos priedas (šis „**Priedas**“) yra Programėlių kūrėjo sutarties; „Microsoft Store“ sąlygų priedas. Šis Priedas taikomas, jei nusprendžiate dalyvauti Programėlės reklamavimo programos, kaip aprašyta šiame Priede. Išskyrus sąlygas, kurios yra aiškiai modifikuotos šiame Priede, visos Programėlių kūrėjo sutarties, kuri yra įtraukta į šį dokumentą kaip nuoroda, sąlygos taikomos jūsų „Microsoft“ reklamos paslaugų naudojimui. Didžiosiomis raidėmis parašyti terminai, kurie šiame dokumente nėra apibrėžti, turi tokią pačią reikšmę, kaip Programėlių kūrėjo sutartyje pateikti terminai.

PERSKAITYKITE IR PERŽIŪRĖKITE VISAS ŠIAME PUSLAPYJE NURODYTAS SĄLYGAS BEI STRATEGIJAS, ĮSKAITANT VISAS TOKIOSE SĄLYGOSE BEI STRATEGIJOSE PATEIKTAS NUORODAS. JŪS SUTINKATE SU ŠIOMIS SĄLYGOMIS, KAI PASINAUDOJATE PROGRAMĖLĖS REKLAMAVIMO PROGRAMOS PASLAUGOMIS.

Šios sąlygos ir strategijos („Sąlygos“) yra jūsų („jūs“ arba „Reklamuotojas“) ir „Microsoft Online, Inc.“ („Microsoft“) sutartis. Jos taikomos Programėlės reklamavimo programos paslaugoms („Paslaugos“), nebent jūs (arba jūsų vardu veikianti agentūra) ir „Microsoft“ esate susitarimo, kuris reglamentuoja vaizdinės reklamos paslaugų pirkimą ir pardavimą („Reklamos sutartis“), šalys; tokiu atveju taikomos šios sutarties sąlygos. Jei Reklamos sutarties nėra, tada Paslaugų pirkimą ir pardavimą reglamentuoja standartinės IAB/AAAA internetinei reklamai taikomos sąlygos „Standard Terms and Conditions for Internet Advertising for Media Buys One Year or Less“, kurias galima rasti adresu [http://advertising.microsoft.com/international/iab-terms](http://go.microsoft.com/fwlink/p/?LinkId=530063) (prieigos kodas: ms59436) („IAB sąlygos“), ir likusios šio paragrafo nuostatos. Žodžiai „Nevada“ ir „Kingo apygarda Vašingtone“ įterpiami IAB sąlygų XIV skyriaus (d) dalyje vietoj atitinkamų vietos rezervavimo ženklų. Medijos įmonė – tai „Microsoft Online, Inc.“, Reklamuotojas – tai jūs, o Agentūra – tai jūsų vardu veikianti reklamos agentūra, jei tokia yra. Jei reklamos agentūra neveikia jūsų vardu, IAB sąlygose esanti nuoroda „Agentūra“ bus panaikinta ir pakeista žodžiu „Reklamuotojas“, IAB sąlygų II skyriaus (b) dalis, II skyriaus (d) dalis ir III skyriaus (c) dalis bus panaikintos. Bet kokia IAB sąlygose esanti nuoroda į terminą „svetainė“ arba „svetainės“ taip pat apima svetaines ir programas mobiliesiems. Šiose Sąlygose neapibrėžti iš didžiosios raidės rašomi terminai turės reikšmę, kuri jiems priskirta IAB sąlygose, nebent šiame Priede nurodyta kitaip. Bus laikoma, kad jūs ir „Microsoft“ sudarėte „IO“, kai Programėlės reklamavimo programos tinklalapyje spustelėsite mygtuką „Įrašyti“. Jei IAB sąlygos ar Sutartis (atsižvelgiant į tai, kuri taikoma) prieštarauja šioms Sąlygoms ar atsiranda nesutapimų, taikomos šios Sąlygos. „Microsoft“ gali bet kuriuo metu keisti šias Sąlygas, įskaitant toliau nurodytų strategijų sąlygas, ir bus taikomos tokios atnaujintos Sąlygos.

Toliau pateikiamos strategijos, taikomos Paslaugų, kurias „Microsoft“gali teikti jums, pirkimui ir pardavimui.


**A. STRATEGIJOS IR KITOS JUMS TAIKOMOS SĄLYGOS**

1. **Pristatymo priemonės.** Jei įtraukiate šalį, kuri turėtų pateikti Papildomas ataskaitas ir susijusias paslaugas, tuomet (a) jūs prisiimate visišką atsakomybę už visas išlaidas, susijusias su tomis paslaugomis ir Papildomomis ataskaitomis, (b) Papildomos ataskaitos nebus pagrindu nustatant reklamos teikimą arba atsiskaitymą, ir (c) „Microsoft“ negarantuoja jokių Papildomų ataskaitų tikslumo. Jūs prisiimate atsakomybę už šalies, teikiančios Papildomas ataskaitas ir atliekančios susijusias paslaugas, veiksmus. **Standartinės ataskaitos** – tai rinkos standartas, pagrindinės ataskaitos, kurias generuoja „Microsoft“ (jei reklamą teikia „Microsoft“) arba trečiųjų šalių reklamos serveris (jei reklamą teikia trečioji šalis). Jos generuojamas tik po reklamos įkėlimo į „Microsoft“ produktą, atsakant į iškvietimą iš „Microsoft“ reklamos serverio. **Papildomos ataskaitos** – tai bet kurios kitos ataskaitos, kurios nėra standartinės ataskaitos, įskaitant ataskaitas apie tikrinimą ir matomumą.

2. **Intelektinė nuosavybė.** „Microsoft“ pasilieka visas intelektinės nuosavybės teises, susijusias su Paslaugomis ir Programėlės reklamavimo programos tinklalapiu, technologijomis ir visais jų patobulinimais ar pakeitimais.

3. **Garantijos.** Bet kuriuo šių Sąlygų galiojimo metu jūs pareiškiate, patvirtinate ir įsipareigojate „Microsoft“, kad:

   a. Esate įmonė, o ne vartotojas;

   b. Turite teisę veikti bet kurios trečiosios šalies, kuriai padedate įsigyti Paslaugas, vardu;

4. **Terminas ir nutraukimas.** „Microsoft“ turi teisę be priežasties ar paaiškinimo, apie tai įspėjusi nedelsdama visiškai ar iš dalies nutraukti arba laikinai sustabdyti jūsų naudojimąsi Programėlės reklamavimo programa, atsižvelgdama į visas arba kai kurias jūsų Programėles (kaip apibrėžta Programėlių kūrėjo sutartyje) bet kuriuo laikotarpiu. „Microsoft“ neprisiima atsakomybės už jus dėl šio Priedo ar Reklamos sutarties nutraukimo arba laikino sustabdymo.

5. **Sąlygų pažeidimo ištaisymas.** Jei „Microsoft“ pagrįstai mano, kad jūs pažeidėte šias Sąlygas arba kad kuri nors iš jūsų Programų (kaip apibrėžta Programėlių kūrėjo sutartyje) pažeidžia kuriuos nors taikomus įstatymus, taisykles ar „Microsoft“ strategijas, tuomet „Microsoft“ turi teisę (a) nedelsdama visiškai ar iš dalies nutraukti arba laikinai sustabdyti jūsų naudojimąsi Programėlės reklamavimo programos tinklalapiu ir Paslaugomis, atsižvelgdama į visas arba kai kurias jūsų Programėles, ir (b) laikinai sustabdyti visus jums priklausančius mokėjimus iš „Microsoft“, susijusius su „Microsoft“ internetinės reklamos paslaugomis. Išskyrus „Microsoft“ skirtus mokėjimus, pagal kuriuos nebuvo suteikta Paslaugų, „Microsoft“ neprisiima atsakomybės prieš jus už jokį nutraukimą ar sustabdymą pagal šį skyrių.


**B. KONKREČIOS SĄLYGAS, TAIKOMOS, KAI „MICROSOFT“ TEIKIA ŠIAS REKLAMOS PASLAUGAS:**

1. **Trečiosios šalies duomenys.** Jei Reklamuotojas arba „Microsoft“ naudoja trečiųjų šalių duomenis, kad pateiktų auditorijos segmentams jiems pritaikytas reklamas, kiekviena šalis užtikrins, kad (a) visus vartotojo duomenis ji gavo pagal visus taikomus įstatymus, įskaitant privatumo įstatymus, ir (b) ji turi teisę naudoti vartotojo duomenis taip, kaip nustatyta „Microsoft“ tikslinės reklamos programose.

2. **„Windows“ programėlių tinklas.** Jei „Microsoft“ teikia reklamos paslaugas „Windows“ programėlių tinkle (**WAN**), tuomet toms paslaugoms taikomos šio paragrafo sąlygos. „Microsoft“ ataskaitos apie WAN parodymus ar kitus rezultatus yra geriausia priemonė Reklamuotojo mokėjimams, skirtiems „Microsoft“, apskaičiuoti. „Microsoft“ nustos teikti reklamas, kai bus pasiektas taikomas šalių sutartas maksimalus biudžetas, nebent šalys raštiškai sutaria kitaip. WAN pasiekiami rezultatai negarantuojami. „Microsoft Advertising“ pasiekia viso pasaulio auditoriją. Jei šiose Sąlygose nenurodyta Jungtinių Amerikos Valstijų tikslinė auditorija, šalys sutaria, kad tarp teikiamų parodymų gali būti parodymų vartotojams ne iš Jungtinių Amerikos Valstijų, ir šie ne JAV parodymai neteikiami.

3. **Mobiliųjų skelbimų paskirties vietos.** Mobiliųjų skelbimų paskirties vietų ataskaitos, kurias sugeneruoja „Microsoft“ arba jos paskirtas agentas, bus atsiskaitymo pagrindas.

4. **„Microsoft Store“ programėlės.** Reklamuotojas (arba Reklamuotojo vardu veikianti Agentūra) pripažįsta, kad visos paskirties vietos bus „Microsoft“ arba jos paskirto agento svetainėje. Kai skelbimai teikiami pagal Programėlės reklamavimo programą, ataskaitos, kurias sugeneruoja „Microsoft“ arba jos paskirtas agentas, bus atsiskaitymo pagrindas.

5. **Bendruomenės skelbimai.** „Microsoft“ neteikia jokių garantijų dėl jūsų sukurtų reklamos kampanijų, susijusių su Bendruomenės skelbimų programa, pristatymo ir paskirties vietos prioriteto. Kai skelbimai teikiami pagal Bendruomenės skelbimų programą, ataskaitos, kurias sugeneruoja „Microsoft“ arba jos paskirtas agentas, bus atsiskaitymo pagrindas.


## <a name="exhibit-g-dev-center-benefits-program-addendum"></a>ĮRODYMŲ DOKUMENTAS G: KŪRĖJŲ CENTRO PRIVILEGIJŲ PROGRAMOS PRIEDAS

Paskutinį kartą atnaujinta: 2017 m. spalio 26 d.

Šis Kūrėjų centro privilegijų programos priedas (šis „**Priedas**“) yra Programėlių kūrėjo sutarties; „Microsoft Store“ sąlygų priedas. Išskyrus sąlygas, kurios yra aiškiai modifikuotos šiame Priede, visos Programėlių kūrėjo sutarties, kuri yra įtraukta į šį dokumentą kaip nuoroda, sąlygos taikomos jūsų Kūrėjų centro privilegijų programos naudojimui. Didžiosiomis raidėmis parašyti terminai, kurie šiame dokumente nėra apibrėžti, turi tokią pačią reikšmę, kaip Programėlių kūrėjo sutartyje pateikti terminai.

1. **Programa.** Kūrėjų centro privilegijų programa („Programa“) – tai skatinimo programa, skirta įvairią patirtį turintiems „Windows“ programėlių kūrėjams. Dalyvaudami programoje jūs galite iš „Microsoft“ ar jos trečiųjų šalių partnerių retkarčiais gauti tam tikras privilegijas („Programos privilegijos“).

2. **Kaip tai veikia.** Jūs būsite automatiškai įtraukti į Programą, kai Kūrėjų centre atidarysite „Store“ paskyrą. Programos privilegijos gali būti retkarčiais teikiamos Programos galiojimo laikotarpiu. Jeigu atitinkate Programos privilegijų reikalavimus, galėsite jas pasiekti Programos puslapyje Kūrėjų centre. Norėdami panaudoti arba pasiekti Programos privilegijas, vykdykite nurodymus.

3. **Programos privilegijos; reikalavimai ir apribojimai.**

   a. Norint gauti daugumą Programos privilegijų, jums reikės turėti aktyvią „Store“ paskyrą.

   b. Programos lygis.

   > i. Kai kurios Programos privilegijos bus pateiktos tik kūrėjams, turintiems tam tikrą programėlių kūrimo patirtį. Šios Sutarties tikslais, programėlių kūrimo patirtis bus vadinama „Programos lygiu“.

   > ii. Jūsų Programos lygį nustatys „Microsoft“ atsižvelgdama į tokius dalykus, kaip jūsų esamos Programėlės efektyvumas, rinkos tinkamumas jūsų esamoms Programėlėms ir klientų atsiliepimai apie jūsų esamas Programėles.

   > iii. Jums gali tekti pateikti „Microsoft“ informacijos apie kitose platformose esančias programas, kad „Microsoft“ galėtų nustatyti jūsų Programos lygį. Jums taip pat gali reikėti prisijungti prie trečiųjų šalių paslaugos, kad „Microsoft“ galėtų patikrinti šią informaciją. „Microsoft“ neatsako už tokią trečiosios šalies paslaugą. Jūsų trečiosios šalies paslaugos naudojimui gali būti taikomos tos trečiosios šalies sąlygos.

   > iv. Jūsų programos lygis Programos Galiojimo laikotarpiu gali pakeisti.

   c. Kai kurios Programos privilegijos gali turėti papildomų tinkamumo kriterijų. Norėdami naudotis šiomis Programos privilegijomis, turėsite atitikti papildomus kriterijus. Tokius kriterijus atskleis „Microsoft“, kai Programos privilegijos taps pasiekiamos.

   d. Kai kurioms Programos privilegijoms gali būti taikomos papildomos sąlygos. Naudodami tokias Programos privilegijas jūs sutinkate laikytis šių papildomų sąlygų.

   e. Kai kurias Programos privilegijas gali teikti trečiosios šalys. „Microsoft“ neatsako už trečiosios šalies žiniatinklio svetaines, paslaugas arba Programos privilegijas. Tokių Programos privilegijų naudojimui gali būti taikomos tos trečiosios šalies sąlygos.

   f. **Programos privilegijų skaičius gali būti ribotas, jos gali būti pakeistos be išankstinio įspėjimo ir pasiekiamos ribotą laiką, kol yra turinys. Kai kurios Programos privilegijos gali būti pasiekiamos tik tam tikrose geografinėse teritorijose ir tik keliomis kalbomis. Išsekus Programos privilegijų ištekliams, „Microsoft“ gali pakeisti Programos privilegijas tokios pačios arba didesnės vertės privilegijomis.**

4. **Teisė atšaukti, nutraukti, keisti arba sustabdyti.** „Microsoft“ gali savo nuožiūra visiškai arba iš dalies atšaukti, nutraukti, keisti arba laikinai sustabdyti Programą, Programos sąlygas arba bet kurias Programos privilegijas. „Microsoft“ gali bet kuriuo metu savo nuožiūra sulaikyti, sumažinti arba nutraukti Programos privilegiją, arba jūs galite būti pašalinti iš Programos. „Microsoft“ gali naudotis savo teisėmis, kurios suteikiamos pagal šį Skyrių, dėl bet kokios priežasties, įskaitant, be apribojimų, atvejus, kai jūs pažeidžiate bet kurį iš savo įsipareigojimų pagal šį Priedą, arba, jei jūs esate įtariami dėl sukčiavimo pagal šią Programą. Jei toks įvykis įvyktų, „Microsoft“ galėtų paskelbti pranešimą Programos puslapyje.

5. **Leidimai.** Jūsų dalyvavimo Programoje sąlyga yra tai, kad jūs sutinkate atleisti „Microsoft“ nuo bet kokios atsakomybės, pretenzijų ar veiksmų, susijusių su sužalojimu, žala arba nuostoliais žmonėms ar turtui ir kurie gali kilti dėl prieigos prie Kūrėjų centro, dalyvavimo bet kurioje Programos dalyje, bet kurios Programos privilegijos gavimo, nuosavybės ar naudojimo, arba ruošiantis kokiai nors su Programos privilegijomis susijusiai veiklai, joje dalyvaujant arba pereinant į kurią nors veiklą ar iš jos pasišalinant (jei taikoma), arba Programos sąlygose atsiradus spausdinimo ar kitokių klaidų. „Microsoft“ neteikia jokių pareiškimų ar garantijų dėl Programos privilegijų formos, saugumo ar vykdymo, išskyrus aiškią gamintojo garantiją, kuri gali būti pridėta prie Programos privilegijos. Programos privilegijų gavėjai prisiima visą riziką dėl prekių, gautų kaip Programos privilegijos, praradimo ar pažeidimų. „Microsoft“ neprisiima atsakomybės už jokius produktus ir (arba) paslaugas, kurias kitos dalyvaujančios įmonės siūlo Kūrėjų centre kaip Programos privilegijas.


## <a name="exhibit-h-standard-application-license-terms"></a>ĮRODYMŲ DOKUMENTAS H: STANDARTINĖS PROGRAMOS LICENCINĖS SĄLYGOS

Paskutinį kartą atnaujinta: 2017 m. spalio 26 d.


### <a name="standard-application-license-terms-for-applications-offered-in-the-united-states-and-canada"></a>STANDARTINĖS PROGRAMOS LICENCINĖS SĄLYGOS, TAIKOMOS JUNGTINĖSE AMERIKOS VALSTIJOSE IR KANADOJE SIŪLOMOMS PROGRAMOMS

**„MICROSOFT STORE“, „WINDOWS“ PARDUOTUVĖ IR „XBOX“ PARDUOTUVĖ**

Šios licencinės sąlygos laikomos sutartimi tarp jūsų ir programos leidėjo. Perskaitykite jas. Jos taikomos programinės įrangos programoms, kurias atsisiunčiate iš „Microsoft Store“, „Windows“ parduotuvės arba „Xbox“ parduotuvės (kiekviena jų šiose licencinėse sąlygose nurodoma kaip „Store“), įskaitant bet kokius programos naujinimus arba priedus, išskyrus atvejus, kai programa pateikiama su atskiromis sąlygomis: tokiu atveju taikomos tos sąlygos.

**ATSISIŲSDAMI AR NAUDODAMI PROGRAMĄ ARBA BANDYDAMI TAI ATLIKTI JŪS SUTINKATE SU ŠIOMIS SĄLYGOMIS. JEI SU JOMIS NESUTINKATE, NETURITE TEISĖS IR NEGALITE ATSISIŲSTI ARBA NAUDOTI PROGRAMOS.**

**Programos leidėjas – tai subjektas, licencijuojantis jums programą, kaip nurodyta „Store“.**

**Jei laikotės šių licencinių sąlygų, turite tokias žemiau išvardintas teises.**

1. **DIEGIMO IR NAUDOJIMO TEISĖS; GALIOJIMO PABAIGA.** Programą galite įdiegti ir naudoti „Windows“ įrenginiuose arba „Xbox“ konsolėse, kaip aprašyta mūsų [naudojimo taisyklėse](http://go.microsoft.com/fwlink/p/?LinkId=723143). „Microsoft“ pasilieka teisę bet kuriuo metu pakeisti savo [naudojimo taisykles](http://go.microsoft.com/fwlink/p/?LinkId=723143).

2. **INTERNETE TEIKIAMOS PASLAUGOS.**

   a. **Sutikimas dėl internetu arba belaidžiu ryšiu teikiamų paslaugų.** Jei programa prie kompiuterio sistemų jungiasi internetu, pvz., belaidžiu tinklu, programos naudojimas yra jūsų sutikimas perduoti standartinę įrenginio informaciją (įskaitant, be apribojimų, techninę informaciją apie jūsų įrenginį, sistemą, programos programinę įrangą ir periferinius įrenginius) interneto arba belaidžio ryšio paslaugoms. Jei pateikiamos kitos sąlygos, susijusios su paslaugų, pasiekiamų naudojant programą, naudojimu, taikomos ir tos sąlygos.

   b. **Netinkamas internetu teikiamų paslaugų naudojimas.** Negalite naudoti jokios internetu teikiamos paslaugos taip, kad pakenktumėte jai arba trukdytumėte kitiems naudotis ja ar belaidžiu tinklu. Negalite naudoti paslaugos norėdami turėti prieigą prie bet kokių paslaugų, duomenų, sąskaitų ar tinklų, kai autentiškumas nepatvirtintas.

3. **LICENCIJOS APRĖPTIS.** Ši programa yra licencijuojama, o ne parduodama. Ši sutartis suteikia jums tik tam tikrų teisių naudotis programa. Jei „Microsoft“ panaikina galimybę naudoti programas jūsų įrenginiuose pagal jūsų sutartį su „Microsoft“, visos susijusios licencijos teisės nustos galioti. Programos leidėjas pasilieka visas kitas teises. Nebent taikytini teisės aktai suteikia jums daugiau teisių, nei nurodyta šiame apribojime, programą galite naudoti tik taip, kaip leidžiama šia sutartimi. Tokiu atveju turite laikytis visų programos techninių apribojimų, kurie leidžia ją naudoti tik tam tikrais būdais. Negalite:

   a. apeiti programos techninių apribojimų;

   b. perdaryti, dekompiliuoti ar išskaidyti programos, išskyrus tuos atvejus ir tik tokia apimtimi, kuri leidžiama atitinkamais įstatymais, nepaisant šių apribojimų;

   c. daryti daugiau programos kopijų, nei nurodyta šioje sutartyje ar leista atitinkamo įstatymo, nepaisant šių apribojimų;

   d. skelbti ar kitaip pateikti programą kitiems kopijuoti;

   e. programos nuomoti, suteikti išperkamosios nuomos sąlygomis, skolinti;

   f. perduoti programos arba šios sutarties trečiajai šaliai.

4. **DOKUMENTACIJA.** Jei su programa pateikiama dokumentų, galite kopijuoti ir naudoti dokumentus savo asmeniniais informaciniais tikslais.

5. **TECHNOLOGIJŲ IR EKSPORTO APRIBOJIMAI.** Programai gali būti taikomi Jungtinių Amerikos Valstijų ar tarptautinės technologijų kontrolės ar eksporto įstatymai ir taisyklės. Jūs turite laikytis visų šalies ir tarptautinių eksporto įstatymų bei taisyklių, taikomų programoje naudojamoms ar jos palaikomoms technologijoms. Šie įstatymai apima paskirties vietos, galutinių vartotojų ir galutinio naudojimo apribojimus. Informacijos apie „Microsoft“ prekės ženklu žymimus produktus ieškokite „Microsoft“ eksportavimo svetainėje ([http://go.microsoft.com/fwlink/?LinkId=242130](http://go.microsoft.com/fwlink/?LinkId=242130)).

6. **PALAIKYMO PASLAUGOS.** Kreipkitės į programos leidėją ir sužinokite, ar siūlomos kokios nors palaikymo paslaugos. „Microsoft“, jūsų aparatūros gamintojas ir belaidžio tinklo operatorius (jei vienas iš jų nėra programos leidėjas) nėra atsakingi už programos palaikymo paslaugų teikimą.

7. **VIENTISA SUTARTIS.** Ši sutartis, bet kokia taikoma privatumo strategija, bet kokios papildomos programos sąlygos ir priedų bei naujinimų sąlygos sudaro visą programos licencijos sutartį tarp jūsų ir programos leidėjo.

8. **TAIKYTINA TEISĖ.**

   **a. Jungtinės Amerikos Valstijos ir Kanada. Jei įsigijote programą Jungtinėse Amerikos Valstijose ar Kanadoje, šių sąlygų interpretavimą, pretenzijas dėl jų pažeidimo ir visas kitas pretenzijas (įskaitant vartotojų apsaugos, neteisingos konkurencijos ir civilinės teisės deliktus) reglamentuoja valstijos ar provincijos, kurioje gyvenate (arba, jei įmonė, joje yra pagrindinė verslo vieta), įstatymai nepaisant įstatymų kolizijos principo.**

   **b. Už Jungtinių Amerikos Valstijų ir Kanados ribų. Jei įsigijote programą kitoje šalyje, taikomi tos šalies įstatymai.**

9. **TEISINIS EFEKTAS.** Ši sutartis nustato tam tikras įstatymines teises. Jūs galite turėti kitų teisių pagal savo šalies įstatymus. Ši sutartis nekeičia teisių, suteikiamų jūsų valstijos ar šalies įstatymų, jei jūsų valstijos ar šalies įstatymai to neleidžia.

10. **GARANTIJOS ATSISAKYMAS.** **Programa licencijuojama „tokia, kokia yra“, „su visomis klaidomis“ ir „tada, kai yra pasiekiama“. Jūs prisiimate visą riziką dėl jos kokybės, saugos, patogumo ir efektyvumo. Jei pasirodytų, kad programa turi defektų, jūs prisiimate visas būtinos priežiūros arba taisymo išlaidas. Programos leidėjas, „Microsoft“, belaidžio ryšio operatoriai, kurių tinklu teikiama programa, ir kiekviena atitinkama susijusi įmonė, pardavėjas, agentas ir tiekėjas („Aprėpties šalys“) nesuteikia jokių aiškiai išreikštų su programa susijusių garantijų, patvirtinimų arba sąlygų. Jūs galite turėti papildomų vietiniuose įstatymuose nustatytų vartotojo teisių, kurių ši sutartis negali pakeisti. Vietinių įstatymų leidžiama apimtimi, Aprėpties šalys nesuteikia jokių numanomų garantijų ar sąlygų, įskaitant tinkamumo parduoti, tinkamumo atskiriems tikslams, saugumo, patogumo ir nepažeidžiamumo garantijų bei sąlygas. Jei garantija, patvirtinimas arba sąlyga yra taikoma pagal vietos įstatymus, net jei šios sąlygos to netaiko, jos galioja ne ilgiau kaip 90 dienų nuo programos atsisiuntimo datos.**

11. **TEISIŲ GYNIMO PRIEMONIŲ IR NUOSTOLIŲ APRIBOJIMAI.** **Tiek, kiek nedraudžiama pagal įstatymus, jei yra pagrindo atlyginti nuostolius, galite iš programos leidėjo atgauti tik tiesioginius nuostolius, neviršijančius sumos, kurią sumokėjote už programą, arba 1,00 USD, atsižvelgiant į tai, kuri suma yra didesnė. Jūs sutinkate nereikalauti ir atsisakote bet kokios teisės reikalauti programos leidėjo atlyginti bet kokius kitus nuostolius, įskaitant prarastą pelną ir priežastinius nuostolius, ypatingus, tiesioginius, netiesioginius ar atsitiktinius nuostolius.**

   **Šis apribojimas apima:**

   - **viską, kas susiję su programa ar paslaugomis, kurios teikiamos programoje. ir**
   - **pretenzijas dėl sutarties, garantijos, patvirtinimo arba sąlygos pažeidimo, griežtos atsakomybės, aplaidumo ar kitą deliktą, įstatų ar taisyklių pažeidimą, neteisėtą praturtėjimą, arba bet kokį kitą numanomą pažeidimą, visais atvejais tiek, kiek leidžia taikytina teisė.**

   **Jis taip pat taikomas net tada, kai:**

   - **ši priemonė nevisiškai kompensuoja jūsų patirtus nuostolius arba**
   - **programos leidėjas žinojo arba turėjo žinoti apie tokių nuostolių tikimybę.**



### <a name="standard-application-license-terms-for-applications-offered-in-european-economic-area"></a>STANDARTINĖS PROGRAMOS LICENCINĖS SĄLYGOS, TAIKOMOS EUROPOS EKONOMINĖJE ERDVĖJE SIŪLOMOMS PROGRAMOMS

**„MICROSOFT STORE“, „WINDOWS“ PARDUOTUVĖ IR „XBOX“ PARDUOTUVĖ**

Šios licencinės sąlygos laikomos sutartimi tarp jūsų ir programos leidėjo. Perskaitykite jas. Jos taikomos programinės įrangos programoms, kurias atsisiunčiate iš „Microsoft Store“, „Windows“ parduotuvės arba „Xbox“ parduotuvės (kiekviena jų šiose licencinėse sąlygose nurodoma kaip „Store“), įskaitant bet kokius programos naujinimus arba priedus, išskyrus atvejus, kai programa pateikiama su atskiromis sąlygomis: tokiu atveju taikomos tos sąlygos.

**JEI SU ŠIOMIS SĄLYGOMIS NESUTINKATE, NETURITE TEISĖS IR NEGALITE ATSISIŲSTI ARBA NAUDOTI PROGRAMOS.**
...
2. **INTERNETE TEIKIAMOS PASLAUGOS.**
   ...
   b. **Netinkamas internetu teikiamų paslaugų naudojimas.** Negalite naudoti jokios internetu teikiamos paslaugos taip, kad tyčia pakenktumėte jai arba trukdytumėte kitiems naudotis ja ar belaidžiu tinklu. Negalite naudoti paslaugos norėdami turėti prieigą prie bet kokių paslaugų, duomenų, sąskaitų ar tinklų, kai autentiškumas nepatvirtintas.

3. **LICENCIJOS APRĖPTIS.** Ši programa yra licencijuojama, o ne parduodama. Ši sutartis suteikia jums tik tam tikrų teisių naudotis programa. Jei „Microsoft“ panaikina galimybę naudoti programas jūsų įrenginiuose pagal jūsų sutartį su „Microsoft“, visos susijusios licencijos teisės nustos galioti. Programos leidėjas pasilieka visas kitas teises. Nebent taikytini teisės aktai suteikia jums daugiau teisių, nei nurodyta šiame apribojime, programą galite naudoti tik taip, kaip leidžiama šia sutartimi. Tokiu atveju turite laikytis visų programos techninių apribojimų, kurie leidžia ją naudoti tik tam tikrais būdais. Negalite:

   a. apeiti programos techninių apribojimų;

   b. perdaryti, dekompiliuoti ar išskaidyti programos, išskyrus tuos atvejus ir tik tokia apimtimi, kiek tai aiškiai leidžia kompiuterinėms programoms taikomos autorių teisių įstatymų nuostatos;
...
10. **GARANTIJOS ATSISAKYMAS. Programa licencijuojama „tokia, kokia yra“, „su visomis klaidomis“ ir „tada, kai yra pasiekiama“. Programos leidėjas, „Microsoft“ (jei „Microsoft“ nėra programos leidėjas), belaidžio ryšio operatoriai, kurių tinklu teikiama programa, ir kiekviena atitinkama susijusi įmonė, pardavėjas, agentas ir tiekėjas („Aprėpties šalys“) nesuteikia jokių papildomų sutartinių su programa susijusių garantijų, patvirtinimų arba sąlygų. Jums suteikiamos visos privalomos įstatymuose numatytos garantijos, bet jokių kitų garantijų mes nesuteikiame. Aprėpties šalys nesuteikia jokių numanomų privalomų garantijų, įskaitant tinkamumo parduoti, tinkamumo atskiriems tikslams, saugumo, patogumo ir nepažeidžiamumo garantijas.**

11. **TEISIŲ GYNIMO PRIEMONIŲ IR NUOSTOLIŲ APRIBOJIMAI.**

   **a. Programos leidėjas neatsako už jokį vartotojo turinį ar trečiųjų šalių medžiagą, įskaitant saitus į trečiųjų šalių svetaines, ir vartotojų vykdomą veiklą. Toks turinys ir veikla nėra priskirtina programos leidėjui ir neišreiškia programos leidėjo nuomonės.**

   **b. Programos leidėjas atsako tik jei pažeidžiami esminiai šių licencinių sąlygų įsipareigojimai.**

   **c. Programos leidėjas, jo netiesioginiai agentai ir (arba) teisėti atstovai neatsako už nenumatytą žalą ir (arba) finansinius nuostolius, kai patirta žala (įskaitant prarastą pelną) yra netiesioginė, nebent tai įvyko dėl programos leidėjo, jo netiesioginių agentų ir (arba) teisėtų atstovų didelio aplaidumo ar tyčinio nerūpestingumo.**

   **d. Atsakomybės ribojimas niekaip nekeičia jokios programos leidėjo įstatyminės atsakomybės be kaltės, įskaitant, be apribojimų, atsakomybę pagal atsakomybės už produktus įstatymą ir statutinę atsakomybę dėl garantijos pažeidimo. Tas pats taikoma programos leidėjo, jo netiesioginių agentų ir (arba) teisėto atstovo atsakomybei, kai dėl apgavystės ar aplaidumo pakenkiama asmens sveikatai arba kyla grėsmė gyvybei.**

   **e. Atsižvelgiant į šios programos licencines sąlygas ir (arba) programų ar programoje pasiekiamų paslaugų naudojimą, negali kilti jokių kitų sutartinių ir teisinių pretenzijų, nei tos, kurios nurodytos šio 11 skyriaus (a)–(e) poskyriuose.**



### <a name="standard-application-license-terms-for-applications-offered-in-china"></a>STANDARTINĖS PROGRAMOS LICENCINĖS SĄLYGOS, TAIKOMOS KINIJOJE SIŪLOMOMS PROGRAMOMS
...
3. **LICENCIJOS APRĖPTIS.** Ši programa yra licencijuojama, o ne parduodama. Ši sutartis suteikia jums tik tam tikrų teisių naudotis programa. Jei „Microsoft“, OPM, MMAIS, SINA, „Tencent“ arba CMCC panaikina galimybę naudoti programas jūsų įrenginiuose pagal jūsų sutartį, visos susijusios licencijos teisės nustos galioti. Programos leidėjas pasilieka visas kitas teises. Nebent taikytini teisės aktai suteikia jums daugiau teisių, nei nurodyta šiame apribojime, programą galite naudoti tik taip, kaip leidžiama šia sutartimi. Tokiu atveju turite laikytis visų programos techninių apribojimų, kurie leidžia ją naudoti tik tam tikrais būdais. Negalite:
...
6. **PALAIKYMO PASLAUGOS.** Kreipkitės į programos leidėją ir sužinokite, ar siūlomos kokios nors palaikymo paslaugos. „Microsoft“, OPM, MMAIS, SINA, „Tencent“, CMCC, jūsų aparatūros gamintojas ir belaidžio tinklo operatorius (jei vienas iš jų nėra programos leidėjas) nėra atsakingi už programos palaikymo paslaugų teikimą.

7. **VIENTISA SUTARTIS.** Ši sutartis, bet kokia taikoma privatumo strategija, bet kokios papildomos programos sąlygos ir priedų bei naujinimų sąlygos sudaro visą programos licencijos sutartį.
...
10. **GARANTIJOS ATSISAKYMAS. Programa licencijuojama „tokia, kokia yra“, „su visomis klaidomis“ ir „tada, kai yra pasiekiama“. Visą jos naudojimo riziką prisiimate jūs. Programos leidėjas, „Microsoft“ (jei „Microsoft“ nėra programos leidėjas), OPM, MMAIS, SINA, „Tencent“, CMCC, belaidžio ryšio operatoriai, kurių tinklu teikiama programa, ir kiekviena atitinkama susijusi įmonė, pardavėjas, agentas ir tiekėjas („Aprėpties šalys“) nesuteikia jokių aiškiai išreikštų su programa susijusių garantijų, patvirtinimų arba sąlygų. Visa rizika dėl programos kokybės, saugos, patogumo ir efektyvumo programos priklauso jums. Jei pasirodytų, kad programa turi defektų, jūs prisiimate visas būtinos priežiūros arba taisymo išlaidas. Jūs galite turėti papildomų vietiniuose įstatymuose nustatytų vartotojo teisių, kurių ši sutartis negali pakeisti. Vietinių įstatymų leidžiama apimtimi, Aprėpties šalys nesuteikia jokių numanomų garantijų ar sąlygų, įskaitant tinkamumo parduoti, tinkamumo atskiriems tikslams, saugumo, patogumo ir nepažeidžiamumo garantijų bei sąlygas.**

11. **TEISIŲ GYNIMO PRIEMONIŲ IR NUOSTOLIŲ APRIBOJIMAI. Tiek, kiek nedraudžiama pagal įstatymus, galite iš programos leidėjo atgauti tik tiesioginius nuostolius, neviršijančius sumos, kurią sumokėjote už programą, arba 1,00 USD, atsižvelgiant į tai, kuri suma yra didesnė. Jūs sutinkate nereikalauti ir atsisakote bet kokios teisės reikalauti programos leidėjo atlyginti bet kokius kitus nuostolius, įskaitant priežastinius nuostolius, prarastą pelną, ypatingus, netiesioginius ar atsitiktinius nuostolius.**
...
### <a name="standard-application-license-terms-for-applications-offered-in-all-other-geographies"></a>STANDARTINĖS PROGRAMOS LICENCINĖS SĄLYGOS, TAIKOMOS VISOSE KITOSE GEOGRAFINĖSE VIETOSE SIŪLOMOMS PROGRAMOMS
...
6. **PALAIKYMO PASLAUGOS.** Kreipkitės į programos leidėją ir sužinokite, kokios palaikymo paslaugos siūlomos. „Microsoft“, jūsų aparatūros gamintojas ir belaidžio tinklo operatorius (jei vienas iš jų nėra programos leidėjas) nėra atsakingi už programos palaikymo paslaugų teikimą.

7. **VIENTISA SUTARTIS.** Ši sutartis, bet kokia taikoma privatumo strategija, bet kokios papildomos programos sąlygos ir priedų bei naujinimų sąlygos sudaro visą programos licencijos sutartį tarp jūsų ir programos leidėjo.

8. **TAIKYTINA TEISĖ.**

   **a. Jungtinės Amerikos Valstijos ir Kanada. Jei įsigijote programą Jungtinėse Amerikos Valstijose ar Kanadoje, šios sutarties interpretavimą, pretenzijas dėl jos pažeidimo ir visas kitas pretenzijas (įskaitant vartotojų apsaugos, neteisingos konkurencijos ir civilinės teisės deliktus) reglamentuoja valstijos ar provincijos, kurioje gyvenate (arba, jei įmonė, joje yra pagrindinė verslo vieta), įstatymai nepaisant įstatymų kolizijos principo.**
...
11. **TEISIŲ GYNIMO PRIEMONIŲ IR NUOSTOLIŲ APRIBOJIMAI. Tiek, kiek nedraudžiama pagal įstatymus, jei yra pagrindo atlyginti nuostolius, galite iš programos leidėjo atgauti tik tiesioginius nuostolius, neviršijančius sumos, kurią sumokėjote už programą, arba 1,00 USD, atsižvelgiant į tai, kuri suma yra didesnė. Jūs sutinkate nereikalauti ir atsisakote bet kokios teisės reikalauti programos leidėjo atlyginti bet kokius kitus nuostolius, įskaitant priežastinius nuostolius, prarastą pelną, ypatingus, netiesioginius ar atsitiktinius nuostolius. Jei garantija, patvirtinimas arba sąlyga yra taikoma pagal vietos įstatymus, net jei šios sąlygos to netaiko, jos galioja ne ilgiau kaip 90 dienų nuo programos atsisiuntimo datos.**
...
### <a name="exhibit-i-dev-center-insider-program-addendum"></a>ĮRODYMŲ DOKUMENTAS I: KŪRĖJŲ CENTRO „INSIDER PROGRAM“ PRIEDAS

Paskutinį kartą atnaujinta: 2017 m. spalio 26 d.

Šis Kūrėjų centro „Insider Program“ priedas (šis **Priedas**) yra „Microsoft Store“ Programėlių kūrėjo sutarties („Programėlių kūrėjo sutartis“) sąlygų priedas. Išskyrus sąlygas, kurios yra aiškiai modifikuotos šiame Priede, visos Programėlių kūrėjo sutarties, kuri yra įtraukta į šį dokumentą kaip nuoroda, sąlygos taikomos jūsų dalyvavimui Kūrėjų centro programoje „Insider Program“ (**Programa**) ir bet kokioms su ja susijusioms „Microsoft“ teikiamoms paslaugoms (bendrai – **Programos paslaugos**). Didžiosiomis raidėmis parašyti terminai, kurie šiame dokumente nėra apibrėžti, turi tokią pačią reikšmę, kaip Programėlių kūrėjo sutartyje pateikti terminai.

1. **Priedo aprėptis; pakeitimai.**

   a. **Aprėptis.** Šis Priedas reglamentuoja jūsų dalyvavimą Programoje ir Programos paslaugų naudojimą. Papildomos sąlygos gali būti taikomos programinei įrangai, priedams, naujinimams ir kitoms jūsų naudojamoms „Microsoft“ svetainėms bei paslaugoms, kurios reikalingos naudojant Programos paslaugas. Jei tos papildomos sąlygos prieštarauja šiam Priedui, pirmenybė suteikiama šio Priedo sąlygoms. Jūs sutinkate, kad perskaitysite sąlygas prieš pradėdami naudoti Programos paslaugas, įskaitant susietas sąlygas. Jūs suprantate, kad naudodami Programos paslaugas, galite ratifikuojate šį Priedą ir susijusias sąlygas.

   b. **Priedo pakeitimai.** Retkarčiais „Microsoft“ gali pakeisti arba papildyti šį Priedą. Jei tai padarysim, informuosime jus paskelbdami pranešimą „Microsoft“ svetainėje arba tinklaraštyje, per vartotojo sąsają Kūrėjų centre, el. paštu arba kitomis tinkamomis priemonėmis. Jei naudosite Programos paslaugas po keitimo įsigaliojimo datos, tai reikš jūsų sutikimą su pakeistomis sąlygomis. Jei nesutinkate su pakeitimais, turite nustoti naudoti Programos paslaugas ir vykdyti Programėlių kūrėjo sutarties 8 skyriuje pateiktas nutraukimo instrukcijas. Priešingu atveju jums bus taikomos naujos sąlygos.

2. **Išankstinio leidimo pobūdis, naujinimai ir palaikymas.**

   a. **Išankstinis leidimas ir eksperimentinės paslaugos.** Programos paslaugose saugos, privatumo, pritaikymo neįgaliesiems, prieinamumo ir patikimumo standartai, lyginant su komerciškai teikiamomis paslaugomis, gali būti sumažinti arba pakeisti. Mes galime bet kuriuo metu ir be išankstinio įspėjimo keisti arba nutraukti Programos paslaugas.

   b. **Naujinimai.** Programos paslaugos atnaujinamos automatiškai. Naudodami Programos paslaugas jūs sutinkate gauti automatinius naujinimus be papildomo pranešimo.

   c. **Palaikymas.** Programos paslaugoms gali būti teikiamas ribotas palaikymas arba jis gali būti neteikiamas.

3. **Turinys.**

   Visi dokumentai, vaizdai, Programos svetainės tinklalapių ir kitas turinys, pateikiamas kartu su Programa (bendrai – **Turinys**) yra „Microsoft“ arba jos tiekėjų autorių teisių saugomi darbai. Turinio naudojimą reglamentuoja licencijos sutarties (jei tokia yra), kuri pateikiama su Turiniu arba į jį įtraukiama, sąlygos. Jei su Turiniu nepateikiama ir į jį neįtraukta jokia licencijos sutartis, tuomet Turinio naudojimą reglamentuoja šis Priedas. Išskyrus sąlygas, aiškiai aprašytas šiame skyriuje, negalima kopijuoti, imituoti, publikuoti, perduoti, transliuoti ar platinti jokios Turinio dalies (visos ar atskirų dalių).

4. **Konfidencialumas.**

   Programos paslaugos yra konfidenciali „Microsoft“ informacija, jei nenurodyta kitaip, ir dėl to jūs turite su Programos paslaugomis susijusių konfidencialumo įsipareigojimų, kurie yra išsamiau aprašyti Programėlių kūrėjų sutarties 8 skyriuje.

5. **Leidimai.**

   Jūsų dalyvavimo Programoje sąlyga yra tai, kad jūs sutinkate atleisti „Microsoft“ nuo bet kokios atsakomybės, pretenzijų ar veiksmų, susijusių su sužalojimu, žala arba nuostoliais žmonėms ar turtui, kurie gali kilti dėl prieigos prie Kūrėjų centro, dalyvavimo bet kurioje Programos dalyje, bet kurios Programos paslaugos naudojimo, arba ruošiantis kokiai nors su Programa susijusiai veiklai, joje dalyvaujant arba pereinant į kurią nors veiklą ar iš jos pasišalinant (jei taikoma), arba šiame Priede ar bet kuriose susietose sąlygose atsiradus spausdinimo ar kitokių klaidų. „Microsoft“ neteikia jokių pareiškimų ar garantijų dėl Programos paslaugų formos, funkcionalumo ar efektyvumo.

6. **Teisių išsaugojimas.**

   „Microsoft“ gali turėti patentų, patentų programų, prekių ženklų, autoriaus teisių ar kitų intelektinės nuosavybės teisių, apimančių Programos paslaugų turinį. Išskyrus sąlygas, aiškiai aprašytas kurioje nors rašytinėje „Microsoft“ licencijos sutartyje, Programos paslaugų arba susijusio Turinio teikimas nesuteikia jums jokios šių patentų, prekių ženklų, autorių teisių arba kitos intelektinės nuosavybės licencijos. „Microsoft“ pasilieka visas teises, kurios nėra aiškiai suteikiamos pagal šį Priedą, ir pagal šį Priedą jokios kitos teisės netiesiogiai, dėl patento turėtojo sutikimo ar kitų priežasčių nesuteikiamos.

7. **Atsiliepimai.** Jei pateiksite „Microsoft“ atsiliepimų apie Programą arba Programos paslaugas, suteiksite „Microsoft“ teisę nemokamai naudoti, bendrinti ir parduoti jūsų atsiliepimus bet kokiu būdu ir bet kokiais tikslais. Jūs taip pat nemokamai suteikiate trečiosioms šalims bet kokias patentų teises, leidžiančias jų produktams, technologijoms ir paslaugoms naudotis arba susisieti su bet kuriomis konkrečiomis „Microsoft“ programinės įrangos arba paslaugos dalimis, apimančiomis jūsų atsiliepimus. Jūs neteiksite grįžtamojo ryšio, susijusio su licencija, kuri reikalauja, kad „Microsoft“ licencijuotų savo programinę įrangą arba dokumentus trečiosioms šalims, nes „Microsoft“ įtraukia jūsų atsiliepimus į savo programinę įrangą arba dokumentus. Šios teisės, kurias 7 skyriuje suteikiate „Microsoft“ ir trečiosioms šalims, tebebus taikomos po Programėlių kūrėjo sutarties, šio Priedo arba jūsų teisių naudoti Kūrėjų centrą arba Programos paslaugas nutraukimo.

8. **Nutraukimas.**

   Norėdami išeiti iš Programos galite bet kuriuo metu nutraukti šį Priedą pasinaudodami Kūrėjų centro funkcijomis.

   „Microsoft“ pasilieka teisę bet kuriuo metu, iš anksto nepranešus ir dėl bet kokios priežasties nutraukti jūsų dalyvavimą Programoje ir jūsų prieigą prie bet kurios arba visų Programos paslaugų.

   Nutraukus Programos paslaugų naudojimą arba prieigą prie jų arba nutraukus šį Priedą, nutraukiama jūsų teisė naudotis Programos paslaugomis. Nutraukus šį Priedą, turite toliau laikytis 4 skyriaus („Konfidencialumas“) sąlygų. Po nutraukimo „Microsoft“ gali toliau naudoti visus duomenis, kurie buvo surinkti prieš nutraukimą.

9. **Draudžiamas Programos paslaugų naudojimas.**

   Jūs negalite naudoti Programos paslaugų jokiu tikslu, kuris yra neteisėtas arba draudžiamas pagal šį Priedą, Programėlių kūrėjo sutartį arba kurį nors dokumentą. Negalite naudoti Programos paslaugų tokiu būdu, kuris pažeistų, išjungtų, perkrautų arba sugadintų „Microsoft“ serverį ar tinklą (-us), prijungtą (-us) prie bet kurio „Microsoft“ serverio, ar trukdytų kitoms šalims naudotis Programos paslaugomis arba kitomis „Microsoft“ paslaugomis ar produktais. Negalite bandyti gauti neteisėtos prieigos prie jokių Programos paslaugų, kitų paskyrų, kompiuterių sistemų ar tinklų, prijungtų prie bet kurio „Microsoft“ serverio ar bet kurios Programos paslaugos, bandydami įsilaužti, sužinoti slaptažodį ar kitais būdais. Jūs negalite gauti ar bandyti gauti jokios medžiagos ar informacijos tokiomis priemonėmis, kurios specialiai nepateiktos Programos paslaugose.


### <a name="see-also"></a>Taip pat žr.

- [Programėlių kūrėjo sutarties keitimų istorija](app-developer-agreement-change-history.md)
